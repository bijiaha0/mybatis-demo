...
public class CangSmallMovie implements SmallMovie {
	...
	public CangSmallMovie(String actor, String director, String bianju, String sheji) {
		super();
		this.actor = actor;
		this.director = director;
		this.bianju = bianju;
	...
	public CangSmallMovie(String actor, String director, String bianju, String sheji, String music) {
		super();
		this.actor = actor;
		this.director = director;
		this.bianju = bianju;
	...
	public CangSmallMovie(String actor, String director, String bianju, String sheji, String music, String light, BigDecimal money, String jianji, String paiShe, String xuanChuan) {
		super();
		this.actor = actor;
		this.director = director;
		this.bianju = bianju;
